...
loadData();
function loadData() {
    const sheet = "weekly_top_cs152";
    const sheet2 = "overAll_top_std_cs152";
...
function createContent(item, container) {
    ...
    let parentDiv = document.getElementById(container);
        ...
        ${item.position !== "" ? `<div class="fame-position-image"><img class="staffer-image fame-badge-image"src="/assets/images/positions/${item.position && item.position+".jpeg"}" iserror="this.src='/assets/images/students/placeholder.jpg';" alt="user-image"></div>` : ""}` : "" }`
    }`
